...
public class IndexModel : PageModel
{
    ...
    private const string OpenAIApiKey = "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";
    ...
    public async Task OnGetAsync()
    {
        ...
        if (user == null)
        {
            // Handle the null case, e.g., log a warning or redirect the user
            _logger.LogWarning("No user is currently logged in.");
            // Optionally, redirect or take other action
        }
        else
        {
            // User is logged in, you can access user properties here
